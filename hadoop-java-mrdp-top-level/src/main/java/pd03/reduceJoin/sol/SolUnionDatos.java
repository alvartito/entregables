...
public class SolUnionDatos implements Writable {
	...
	public SolUnionDatos(BooleanWritable isEmployee, Text nombre,
			Text apellido, Text fechaInc) {
	...
	public SolUnionDatos(BooleanWritable isEmployee, IntWritable sueldo,
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof SolUnionDatos))
			return false;
		SolUnionDatos other = (SolUnionDatos) obj;
		if (apellido == null) {
	...
	public String toString() {
		return "SolUnionDatos [sueldo=" + sueldo + ", fechaIni=" + fechaIni
