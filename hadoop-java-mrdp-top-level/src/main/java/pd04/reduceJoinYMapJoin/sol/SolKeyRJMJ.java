...
public class SolKeyRJMJ implements WritableComparable<SolKeyRJMJ> {
	BooleanWritable isEmployee;
	IntWritable id;

	public int compareTo(SolKeyRJMJ o) {
	...
	public SolKeyRJMJ(BooleanWritable isEmployee, IntWritable id) {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof SolKeyRJMJ))
			return false;
		SolKeyRJMJ other = (SolKeyRJMJ) obj;
		if (id == null) {
			if (other.id != null)
				return false;
